...
\def\maintitle{Operációs rendszerek 1. -- 3. elõadás \\ Az operációs rendszer mûködése, 2. változat}
\def\shorttitle{OPRE1 -- 3 - Mûködés v2.0}
\def\longdate{2011. õsz}
\def\shortdate{2011. õsz}
...
\only<beamer>{
\pgfdeclareimage[height=1cm]{university-logo}{images/fmk_nyme_600_300}
